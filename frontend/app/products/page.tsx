    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800' : 'bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50'}`}>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-xl text-blue-100">Discover our premium collection of products</p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 sm:mb-8">
          ...
          <div className="w-full md:w-1/2 lg:w-2/5 relative group">
            ...
            <input
              ...
              className={`w-full pl-10 sm:pl-12 pr-10 py-2.5 sm:py-3 border-2 rounded-xl focus:ring-2 focus:outline-none transition-all text-sm sm:text-base shadow-sm ${isDarkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-blue-900' : 'bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-blue-100'}`}
            />
            {searchQuery && (
              <button
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            >
              <button className={`flex items-center gap-2 min-w-[180px] sm:min-w-[200px] pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 border-2 rounded-xl focus:ring-2 focus:outline-none transition-all text-sm sm:text-base font-semibold shadow-md cursor-pointer hover:shadow-lg ${isDarkMode ? 'bg-gradient-to-r from-gray-800 to-purple-900/40 border-gray-700 text-gray-200 hover:border-purple-600 focus:border-purple-500 focus:ring-purple-900' : 'bg-gradient-to-r from-white to-purple-50 border-purple-200 text-gray-900 hover:border-purple-300 focus:border-purple-500 focus:ring-purple-100'}`}>
            ...
            {/* Results Count */}
            <div className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border-2 whitespace-nowrap transition-all ${isDarkMode ? 'bg-gradient-to-r from-gray-800 to-purple-900/40 border-gray-700' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-purple-200'}`}>
